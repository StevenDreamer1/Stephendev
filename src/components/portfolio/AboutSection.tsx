        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {skills.map((skill, index) => (
              <Card 
                key={index} 
                className={`p-6 shadow-card hover:shadow-hover transition-spring border-card-border group flex flex-col items-center justify-between text-center transform ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'} aspect-square`} /* Added aspect-square for cube-like shape */
              ...
              >
                ...
                <div className="space-y-1 text-left w-full pl-4 flex-grow"> {/* Align text left within card */}
